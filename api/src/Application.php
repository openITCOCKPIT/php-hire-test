...
class Application extends BaseApplication
{
    ...
    public function middleware(MiddlewareQueue $middlewareQueue): MiddlewareQueue
    {
        ...
        // CakePHP's cookie-based CsrfProtectionMiddleware was intentionally
        // removed for this stateless JSON API. There is no cookie session for
        // CSRF to protect, and the token requirement would block the Angular
        // SPA's cross-origin POST requests (issue #6). See docs/implementation.
